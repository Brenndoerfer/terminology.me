...
import { BeakerIcon, CloudIcon, CodeIcon, CubeIcon, CurrencyDollarIcon, DatabaseIcon } from '@heroicons/react/outline';
        ...
        <>
            ...
            <div className="relative lg:grid lg:grid-cols-3 lg:gap-x-8">
                <div className="lg:col-span-1">
                    <H2 underline={false}>Terminology for the modern engineer</H2>
                </div>
                <dl className="mt-10 space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:gap-x-8 sm:gap-y-10 lg:mt-0 lg:col-span-2">
                    {features.map((feature) => (
                        <Link href={feature.href} key={feature.name} passHref={true}>
                            <div className="cursor-pointer hover:bg-white hover:border-gray-100 border border-gray-50 border-white hover-fade rounded-lg hover:shadow-sm p-6">
                                <dt>
